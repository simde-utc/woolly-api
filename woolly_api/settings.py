...
OAUTH = {
    'portal': {
        ...
        'scope':            'user-get-assos user-get-info user-get-roles',  # TODO user-get-assos-members-joined-now',
    },
}
...
SESSION_ENGINE = 'django.contrib.sessions.backends.cached_db'  # TODO cache or cached_db
