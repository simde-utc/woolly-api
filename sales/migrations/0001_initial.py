# Generated by Django 2.0.3 on 2018-06-05 05:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[('ONGOING', 0), ('AWAITING_VALIDATION', 1), ('VALIDATED', 2), ('NOT_PAYED', 3), ('PAYED', 4), ('EXPIRED', 5), ('CANCELLED', 6)], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orderlinefields', to='sales.OrderLine')),
            ],
        ),
        migrations.CreateModel(
            name='Sale',
